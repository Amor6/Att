...
class Partners(models.Model):
    ...
    part = models.ForeignKey('Partners', on_delete=models.PROTECT, verbose_name='Поставщик', **NULLABLE)
    ...
    levels = models.IntegerField(choices=Levels.choices, default=Levels.FACTORY, verbose_name='Структура')
